...
public interface CommandeFournisseurApi {
    ...
    @GetMapping(value =  APP_ROOT+ "/commandeclients/{idCmdFournisseur}" , produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT + "/commandeclients/{codeCmdFournisseur}", produces = MediaType.APPLICATION_JSON_VALUE)
